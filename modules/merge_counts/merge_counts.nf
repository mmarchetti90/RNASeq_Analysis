process MergeCounts {
    ...
    publishDir "${projectDir}/${params.transcript_counts_dir}", mode: "copy", pattern: "MergedTranscriptCounts.tsv"
    publishDir "${projectDir}/${params.gene_counts_dir}", mode: "copy", pattern: "MergedmiRNACounts.tsv"
    publishDir "${projectDir}/${params.exon_counts_dir}", mode: "copy", pattern: "MergedExonCounts.tsv"
    ...
    output:
    path "*Counts.tsv", optional: true, emit: merged_counts
