...
include { IntegrateAnalyses } from '../modules/differential_analysis/integrate_dexseq_sleuth.nf'

workflow TRANSCRIPTLVL {
  ...
  if (params.alignment_only == false) {
    ...
    IntegrateAnalyses(scripts_dir, genome_annotation, analysis_integration_input)
